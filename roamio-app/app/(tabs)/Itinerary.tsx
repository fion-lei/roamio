...
[
  ...
  { id: "4", title: "Cultural Performance", date: "March 22, 2025", description: "Enjoy a traditional cultural performance with music and dance." },
  ...
  return (
    <SafeAreaView style={styles.safeContainer}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => <ItineraryItemComponent item={item} />}

        ListHeaderComponent={<Text style={styles.header}>My Itinerary</Text>}
