...
const activityCards: ActivityCard[] = [ 
  ...
  { 
    id: "commonwealth", 
    title: "Commonwealth Bar", 
    address: "731 10 Ave SW,", 
    hours: "Monday - Friday, 9:00PM - 2:00AM", 
    contact: "(403) - 244 - 0444", 
    description: `Commonwealth Bar & Stage is a popular nightlife destination in Calgary with multiple entertainment levels. This converted warehouse features two dance floors, DJ nights, and live performances. Known for its industrial-chic atmosphere, craft cocktails, and energetic crowd, it's a staple of Calgary's nightlife scene. The venue hosts both local and international DJs and themed events in a spacious setting with excellent sound and lighting.`,
    image: require("@/assets/images/beer.png"),
    category: ["hotspot", "dining", "culture"], 
    tags: ["#Nightlife", "#Bar", "#LiveMusic", "#Trendy", "#Groovy"],
    price: "$$",
    rating: 4.2,
    ratingCount: 976, 
  },
