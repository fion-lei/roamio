...
const DetailScreen = () => {
  ...
  const { name, phone, avatar, email_friend, first_name, traveller_type, bio } = route.params as RouteParams;
  const { user } = useUser();
  ...
  {favorited ? (
    ...
    <Feather name="star" size={25} color="#999" style={{ marginLeft: 20, marginBottom: 15 }} />
      ...
      <View style={styles.infoList}>
        ...
        <InfoItem icon={<FontAwesome name="plane" size={20} />} text={traveller_type} />
